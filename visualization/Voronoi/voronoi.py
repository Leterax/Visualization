...
class Voronoi(moderngl_window.WindowConfig):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.voronoi_program = self.load_program("voronoi_shader.glsl")
        self.voronoi_program["iResolution"].value = (
        ...
        self.velocities = (np.random.random_sample((self.n, 2)) - 0.5) / 250
